...
namespace ImageTemplateMatching
{
    ...
    public static class Image
    {
        ...
        public static Bitmap Clone( BitmapData sourceData )
        {
            ...
            ImageTemplateMatching.SystemTools.CopyUnmanagedMemory( destinationData.Scan0, sourceData.Scan0, height * sourceData.Stride );
        ...
        /// by the <b>ImageTemplateMatching</b> library. The image is left untouched in the
        ...
        /// <code>
        /// Bitmap image = ImageTemplateMatching.Image.FromFile( "test.jpg" );
        /// </code>
        /// </remarks>
        /// 
